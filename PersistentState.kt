...
class PersistentState(context: Context) : SimpleKrate(context), KoinComponent {
    ...
    // biometric authentication (pending removal)
    ...
    // stall on no network
    // add routes as normal but do not send fd to netstack
    ...
    data class DnsCryptRelayDetails(val relay: DnsCryptRelayEndpoint, val isAdded: Boolean)
